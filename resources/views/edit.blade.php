...
<body>
    <div class="container-fluid  ma-con">
        ...
        <H1 class="text-center">แก้ไขข้อมูลนักศึกษา ผู้กู้ยืม กยศ. </h1>
        <div class="con">
            <form method="post" action="{{action('App\Http\Controllers\StudentloadController@update', $id)}}">
                {{csrf_field()}}
                @method('PUT')
                <div>
                    <div class="row form-group">
                        ...
                        <div class="col-sm-8 ">
                            <input readonly type="text" class="form-control" id="stdid" placeholder="กรอกรหัสนักศึกษา" name="stdid" value="{{$tmpstudent->stdid}}">
                        </div>
                    </div>
                    <div class="row form-group">
                        <label class="col-sm-4 ">ชื่อ-สกุล :</label>
                        <div class="col-sm-8 ">
                            <input type="text" class="form-control" id="stdname" placeholder="กรอกชื่อ - สกุล" name="stdname" value="{{$tmpstudent->stdname}}">
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-sm-8 ">
                            <select class="form-control" id="faculty" name="faculty">
                                <option value="{{$tmpstudent->faculty}}" selected>-{{$tmpstudent->faculty}}-</option>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-8 ">
                            <input type="number" class="form-control" id="year" placeholder="ปีการศึกษา เช่น 2564" name="year" value="{{$tmpstudent->year}}">
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class=" col-sm-8 ">
                            <select class=" form-control" id="term" name="term">
                                <option value="{{$tmpstudent->term}}" selected>-{{$tmpstudent->term}}-</option>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-8 ">
                            <input type="number" class="form-control" id="termfees" placeholder="กรอกค่าเทอมตามจริง" name="termfees" value="{{$tmpstudent->termfees}}">
                        </div>
                    </div>
                    <div class="row form-group">
                        <label class="col-sm-4 ">ค่าครองชีพ :</label>
                        <div class="col-sm-8 ">
                            <input readonly type="number" class="form-control" id="livecost" value="18000" placeholder="18,000" name="livecost" value="{{$tmpstudent->livecost}}">
                        </div>
                    </div>
                </div>
                <br>
